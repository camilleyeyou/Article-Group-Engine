            ...
            <div className="lg:col-span-1">
              <div className="sticky top-32">
                ...
                <p className="text-4xl font-black text-violet-600 leading-tight">
                  Before.<br/>
                  After.<br/>
                  <span className="text-fuchsia-500">Beyond.</span>
                </p>
              </div>
            </div>
      ...
      {caseStudies.length > 0 && (
        <section className="py-24 px-6 bg-slate-50">
          <div className="max-w-7xl mx-auto">
            ...
            >
              <div>
                <span className="text-violet-500 font-semibold tracking-wide uppercase mb-2 block">
                  Transformations
                </span>
              ...
              {caseStudies.map((asset, i) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 p-8 md:p-12 flex flex-col justify-end text-white">
                    {asset.client && (
                      <span className="text-white/60 text-sm tracking-wide uppercase mb-2">
                        {asset.client}
                      </span>
                    )}
                    <h3 className="text-2xl md:text-4xl font-bold mb-4 group-hover:translate-x-2 transition-transform">
                      {asset.title}
                    </h3>
        ...
        <section className="py-24 px-6">
          <div className="max-w-6xl mx-auto">
            <motion.div
              ...
              className="mb-16"
            >
              <span className="text-fuchsia-500 font-semibold tracking-wide uppercase mb-2 block">
                The Edit
              </span>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12">
              {articles.slice(0, 6).map((asset, i) => (
                ...
                >
                  {/* Colored bar */}
                  <div className={`h-2 w-16 mb-4 ${
                    i % 3 === 0 ? 'bg-violet-500' : i % 3 === 1 ? 'bg-fuchsia-500' : 'bg-pink-500'
                  }`} />
      ...
      <section className="relative py-32 px-6 overflow-hidden">
        ...
        >
          ...
          <p className="text-xl text-white/80 mb-12 max-w-2xl mx-auto">
            Your brand has a story to tell. Let&apos;s make sure the world 
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="#"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-violet-600 rounded-full font-bold hover:shadow-2xl hover:scale-105 transition-all"
            >
              Start your rebrand
            ...
            <a
              href="#"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 border-2 border-white/30 rounded-full font-bold hover:bg-white/10 transition-colors"
            >
              See our process
            </a>
          </div>
