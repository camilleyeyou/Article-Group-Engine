    ...
    <div className="bg-black text-white min-h-screen">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-8 leading-[0.9] tracking-tight">
              <span className="block text-white/40 text-2xl md:text-3xl font-normal tracking-widest uppercase mb-4">
                Your Challenge
              </span>
              {query}
            </h1>
            ...
            <p className="text-xl md:text-2xl text-white/60 max-w-3xl mx-auto leading-relaxed">
              We craft keynotes that command attention and drive action
            </p>
          </motion.div>
        </div>
      ...
      <section className="relative py-32 px-6">
        ...
        >
          ...
          <blockquote className="text-2xl md:text-4xl font-light leading-relaxed text-white/90 mb-8">
            {narrative}
          </blockquote>
        ...
        <section className="py-24 px-6">
          <div className="max-w-7xl mx-auto">
            <motion.div
              ...
              className="mb-16"
            >
              <span className="text-red-400 text-sm tracking-widest uppercase mb-4 block">
                Featured Work
              </span>
              <h2 className="text-4xl md:text-5xl font-bold">
                Keynotes that made
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-orange-400"> history</span>
              </h2>
            </motion.div>
            ...
            <div className="grid gap-8">
              {caseStudies.map((asset, i) => (
                ...
                >
                  <Link href={`/asset/${asset.id}`} className="group relative block">
                    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-zinc-900 to-zinc-800 border border-white/10 p-8 md:p-12 hover:border-red-500/50 transition-all duration-500">
                      ...
                      <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-8">
                        ...
                        <div className="flex-1">
                          {asset.client && (
                            <span className="text-red-400 text-sm tracking-wide uppercase mb-2 block">
                              {asset.client}
                            </span>
                          )}
                          <h3 className="text-2xl md:text-3xl font-bold text-white mb-3 group-hover:text-red-100 transition-colors">
                            {asset.title}
                          </h3>
            ...
            <div className="space-y-1">
              {articles.slice(0, 5).map((asset, i) => (
                <motion.a
                  ...
                  className="group flex items-center justify-between py-6 border-b border-white/10 hover:border-red-500/30 transition-colors"
                >
      ...
      <section className="relative py-32 px-6 overflow-hidden">
        ...
        >
          ...
          <p className="text-xl text-white/60 mb-10 max-w-xl mx-auto">
            Let&apos;s craft a keynote that your audience will never forget.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="#"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-red-500 to-orange-500 rounded-full font-semibold hover:shadow-lg hover:shadow-red-500/25 transition-all"
            >
            ...
            <a
              href="#"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 border border-white/20 rounded-full font-semibold hover:bg-white/5 transition-colors"
            >
              See more work
            </a>
          </div>
